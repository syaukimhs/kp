...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-tbl">
        <h1 class="text-center mb-4">Form Materi/Paparan</h1>
        <div class="row justify-content-center">
          <div class="col-10">
          <div class="card">
            <div class="card-body">
            <form action="/inserttbmateri" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="mb-3">
              ...
              <a href="/tbmateri" class="btn btn-danger">Batal</a>
            </form>
            </div>
          </div>
          </div>
