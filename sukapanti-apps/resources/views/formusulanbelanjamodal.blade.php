...
<html lang="en">
  ...
  <body>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
              <li class="nav-item">
                <a class="nav-link mx-lg-2 active" aria-current="page" href="/usulanbelanjamodal">Usulan Belanja Modal</a>
              </li>
              <li class="nav-item">
    ...
    <!-- tabel -->
        ...
        <h1 class="text-center mb-4">Form Usulan Belanja Modal</h1>
        <div class="row justify-content-center mb-4">
          <div class="col-10">
          <div class="card">
            <div class="card-body">
            <form action="/insertdatabelanjamodal" method="POST" enctyope="multipart/form-data">
              @csrf
              <div class="mb-3"> 
              ...
              <div class="mb-3">
                ...
                <input type="text" name="usulan" class="form-control" id="exampleInputPassword1" placeholder="Inputkan Usulan" required>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Peruntukan</label>
                <input type="text" name="peruntukan" class="form-control" id="exampleInputPassword1" placeholder="Inputkan Peruntukan" required>
              </div>
              <button type="submit" class="btn btn-primary">Submit</button>
              <a href="/usulanbelanjamodal" class="btn btn-danger">Batal</a>
            </form>
            </div>
          </div>
          </div>
