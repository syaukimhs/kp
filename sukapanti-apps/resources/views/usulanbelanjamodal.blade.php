...
<html lang="en">
  <head>
    ...
    <title>Usulan Belanja Modal</title>
  ...
  <body>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
              <li class="nav-item">
                <a class="nav-link mx-lg-2 active" aria-current="page" href="#">Usulan Belanja Modal</a>
              </li>
              <li class="nav-item">
   ...
   <div class="container-fluid">
        <div class="tbl">
          <h1 class="text-center mb-4">Data Usulan Belanja Modal</h1>
          </div>
            <div class="tombol">
              <a href="/formusulanbelanjamodal" class="btn btn-success">Tambah Data</a>
               @if (auth()->user() <> null) 
               <!-- if pertama untuk ngecek apakah sudah login atau belum -->
                ...
                <!-- <a href="/cetakbelanjamodal" target="_blank" class="btn btn-primary">Cetak Data</a> -->
                @endif
              @endif
            </div>
        ...
        <div class="row">
          ...
          <div class="table-wrapper table-responsive">
            <table id="tabel_1"  class="table table-striped table-hover col-12 table-bordered">
            <thead>
                <tr>
                <th scope="col">No</th>
            ...
            <tbody>
              ...
              @foreach ($data as $index => $row)
                ...
                <td>
                    ...
                    <a href="/deletedatabelanjamodal/{{ $row->id }}" class="btn btn-danger">Hapus</a>
                </td>
                </tr>
              @endforeach
            </tbody>
