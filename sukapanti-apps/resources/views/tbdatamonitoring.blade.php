...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <div class="tbl">
          <h1 class="text-center mb-4">Dokumen Data Monitoring/Evaluasi</h1>
        </div>
            <div class="tombol">
            ...
            @if (auth()->user()->username == 'admin')
              ...
              <a href="/formtbdatamonitoring" class="btn btn-success">Tambah Data</a>
              @endif
            @endif
            ...
            <a href="/" class="btn btn-danger">Kembali</a>
              <div class="row g-3 align-items-center mt-2">
                <div class="col-auto">
                  <!-- <form action="/tbdatamonitoring" method="GET"> 
          ...
          <div class="table-wrapper">
            ...
            <tbody>
              ...
              @foreach ($data as $index => $row)
                ...
                <td>{{ $row->name }}</td>
                <td><a href="/downloaddoc1/{{ $row->file }}" class="btn btn-success">Download</a></td>
                @if (auth()->user() <> null)
                <!-- if pertama untuk ngecek apakah sudah login atau belum -->
                @if (auth()->user()->username == 'admin')
                  <!-- if yg kdua ini utk ngecek login sebagai apa, apakah admin atau panti -->
                   <td><a href="/deletetbdatamonitoring/{{ $row->id }}" class="btn btn-danger">Hapus</a></td>
                  @endif
                @endif
