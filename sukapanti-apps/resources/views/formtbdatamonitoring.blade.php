...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-tbl">
        <h1 class="text-center mb-4">Form Monitoring/Evaluasi</h1>
        <div class="row justify-content-center">
          <div class="col-10">
          <div class="card">
            <div class="card-body">
            <form action="/inserttbdatamonitoring" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="mb-3">
              ...
              <a href="/tbdatamonitoring" class="btn btn-danger">Batal</a>
            </form>
            </div>
          </div>
          </div>
