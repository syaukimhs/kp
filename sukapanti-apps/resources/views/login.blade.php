            ...
            <div class="card-body">
              ...
              <form action="/loginproses" method="post">
                ...
                <div class="text-center mt-3">
                  <button type="submit" class="btn btn-primary btn-block" style="width: 500px">Login</button>
                  
                </div>                
              </form>
              <p class="mb-0">
                <a href="/register" class="nav-link mt-3" style="color: blue">Belum Punya Akun? Silahkan Register</a>
                <a href="/portal" class="nav-link mt-1" style="color: blue">kembali</a>
              </p>
            </div>
          </div>
        </div>
